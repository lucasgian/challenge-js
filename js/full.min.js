...
var Cover,__bind=function(e,t){return function(){return e.apply(t,arguments)}};Cover=function(){function t(){this.hideCanvas=__bind(this.hideCanvas,this);this.showCanvas=__bind(this.showCanvas,this);this.resize=__bind(this.resize,this);this.handleTick=__bind(this.handleTick,this);this.showLogo=__bind(this.showLogo,this);this.repositionLogo=null;TweenMax.set($(".cover"),{opacity:0})}var e;t.prototype.render=!1;t.prototype.timer=0;e=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame;t.prototype.init=function(){var e,t,n,r,i,s=this;this.width=$(".cover").width();this.height=$(".cover").height()-137;this.formLogo=!1;this.canvas=document.getElementById("coverCanvas");this.canvas.width=$(window).width();this.canvas.height=$(window).height();this.canvas.addEventListener("click",this.showLogo);this.context=this.canvas.getContext("2d");this.colors=["rgba(255,255,255,0.08)","rgba(255,255,255,0.05)","rgba(255,255,255,0.1)"];this.bgImage=document.createElement("img");this.bgImage.onload=function(){s.bgLoaded=!0;s.bgX=0;s.bgY=0;s.bgW=s.bgImage.width;s.bgH=s.bgImage.height;console.log("imgload");if(s.width>s.bgImage.width||s.height>s.bgImage.width){console.log("resize");if(s.width<s.height){console.log("resize 1");s.bgImage.width=s.bgImage.width*(s.height/s.width);s.bgImage.height=s.height;s.bgW=s.bgImage.width;s.bgX=(s.width-s.bgW)*.5}else{console.log("resize 2");s.bgImage.height=s.bgImage.height*(s.width/s.height);s.bgImage.width=s.width;s.bgH=s.bgImage.height;s.bgY=(s.height-s.bgH)*.5}}else{s.bgX=(s.width-s.bgW)*.5;s.bgY=(s.height-s.bgH)*.5}s.bgW=s.bgImage.width;return s.bgH=s.bgImage.height};this.bgImage.src="media/images/background.png";this.lingrad=this.context.createRadialGradient(this.width*.5,this.height*.5,this.height*.15,this.width*.5,this.height*.5,this.height);this.lingrad.addColorStop(0,"#141414");this.lingrad.addColorStop(.7,"#000000");this.dots=[];e=-1;r=2e4;t=0;i=2e4;n=0;while(++e<SliklandLogo.length){SliklandLogo[e].x<r&&(r=SliklandLogo[e].x);SliklandLogo[e].x>t&&(t=SliklandLogo[e].x);SliklandLogo[e].y<i&&(i=SliklandLogo[e].y);SliklandLogo[e].y>n&&(n=SliklandLogo[e].y)}this.logoBaseW=t-r;this.logoBaseH=n-i;this.logoPos=SliklandLogo;this.maxDots=this.logoPos.length+30;this.createDots();return!1};t.prototype.createDots=function(){var t,n,r,i,s,o,u,a,f,l,c;u=this.logoBaseW;o=this.logoBaseH;f=1;if(this.width<u||this.height<o)this.width<this.height?f=this.width/u:f=this.height/o;i=u*f;r=o*f;t=(this.width-i)*.5;n=(this.height-r)*.5;for(s=l=0,c=this.maxDots;0<=c?l<c:l>c;s=0<=c?++l:--l){a={};if(this.logoPos[s]){a.px=this.logoPos[s].x*f+t+Math.random()*20-10;a.py=this.logoPos[s].y*f+n+Math.random()*20-10;a.x=a.px;a.y=a.py}else{a.x=Math.random()*(this.width-this.width*.2)+this.width*.1;a.y=Math.random()*(this.height-this.height*.2)+this.height*.1}a.maxV=Math.random()*2.3+.05;a.vx=Math.random()*a.maxV-a.maxV*.5;a.vy=Math.random()*a.maxV-a.maxV*.5;a.maxDist=this.logoPos[s]!=null?(Math.random()*50+50)*f:Math.random()*50+50;a.maxDist=a.maxDist*a.maxDist;a.lineWidth=.15;a.radius=Math.random()*.6+.3;a.connections=[];this.dots.push(a)}this.render=!0;e(this.handleTick);this.showCanvas();!1;return!1};t.prototype.showLogo=function(e){_gaq.push(["_trackEvent","Landing","showFooter","show_footer"]);this.formLogo=!this.formLogo;return!1};t.prototype.handleTick=function(t){var n,r,i,s,o,u;this.timer+=.1;if(this.bgLoaded)this.context.drawImage(this.bgImage,this.bgX,this.bgY,this.bgW,this.bgH);else{this.context.rect(0,0,this.width,this.height);this.context.fillStyle="#000000";this.context.fill()}s=-1;while(++s<this.maxDots){u=this.dots[s];if(this.formLogo)if(u.px){r=Math.atan2(u.py-this.my,u.px-this.mx);u.x+=(u.px-u.x)*.5;u.y+=(u.py-u.y)*.5;u.x+=Math.sin(this.timer+s);u.y+=Math.cos(this.timer+s)}else{u.x+=u.vx;u.y+=u.vy}else{u.x+=u.vx;u.y+=u.vy}u.x>this.width?u.vx*=-1:u.x<0&&(u.vx*=-1);u.y>this.height?u.vy*=-1:u.y<0&&(u.vy*=-1);this.context.beginPath();o=s;while(++o<this.dots.length){i=this.getDist(this.dots[o].x,this.dots[o].y,u.x,u.y);if(i>u.maxDist&&u.connections.indexOf(this.dots[o])!==-1){u.connections.length=0;continue}if(i>u.maxDist)continue;if(u.connections.length<3){u.connections[u.connections.length]=this.dots[o];u.triColor=this.colors[Math.floor(Math.random()*this.colors.length)]}n=1-Math.abs(i/u.maxDist);if(n<=0)continue;this.context.moveTo(u.x,u.y);this.context.lineTo(this.dots[o].x,this.dots[o].y);this.context.lineWidth=u.lineWidth;this.context.strokeStyle="rgba(255,255,255,"+n+")";i=null}this.context.closePath();this.context.stroke();this.context.fillStyle="rgba(255,255,255,0.5)";this.context.beginPath();this.context.arc(u.x-u.radius*.5,u.y-u.radius*.5,u.radius,0,2*Math.PI,!1);this.context.closePath();this.context.fill();this.context.fillStyle="rgba(255,255,255,0.03)";if(u.connections.length===3){this.context.beginPath();this.context.moveTo(u.x,u.y);this.context.lineTo(u.connections[0].x,u.connections[0].y);this.context.lineTo(u.connections[1].x,u.connections[1].y);this.context.lineTo(u.connections[2].x,u.connections[2].y);this.context.closePath();this.context.fill()}}this.render&&e(this.handleTick);return!1};t.prototype.getDist=function(e,t,n,r){return(n-e)*(n-e)+(r-t)*(r-t)};t.prototype.resize=function(){var e=this;this.hideCanvas();this.context.clearRect(0,0,$(window).width(),$(window).height());this.render=!1;clearTimeout(this.repositionLogo);this.repositionLogo=setTimeout(function(){e.destroy();return e.init()},1e3);return!1};t.prototype.showCanvas=function(){TweenMax.to($(".cover"),.5,{opacity:1,ease:"Quad.easeOut"});return!1};t.prototype.hideCanvas=function(){TweenMax.to($(".cover"),.5,{opacity:0,ease:"Quad.easeOut"});return!1};t.prototype.destroy=function(){this.timer=0;this.width=null;this.height=null;this.formLogo=null;this.logoBaseW=null;this.logoBaseH=null;this.canvas.removeEventListener("click",this.showLogo);this.canvas=null;this.context=null;this.colors=null;this.bgLoaded=null;this.bgImage=null;this.lingrad=null;this.logoPos=null;this.maxDots=null;this.dots=null;return!1};return t}();


:531.8571428571429},{x:531.8571428571429,y:531.8571428571429},{x:563.1428571428571,y:531.8571428571429},{x:125.14285714285717,y:563.1428571428571},{x:156.42857142857144,y:563.1428571428571},{x:187.71428571428572,y:563.1428571428571},{x:219,y:563.1428571428571},{x:250.28571428571428,y:563.1428571428571},{x:281.57142857142856,y:563.1428571428571},{x:312.85714285714283,y:563.1428571428571},{x:344.14285714285717,y:563.1428571428571},{x:375.4285714285714,y:563.1428571428571},{x:406.7142857142857,y:563.1428571428571},{x:438.00000000000006,y:563.1428571428571},{x:469.2857142857143,y:563.1428571428571},{x:500.5714285714286,y:563.1428571428571},{x:531.8571428571429,y:563.1428571428571},{x:563.1428571428571,y:563.1428571428571},{x:156.42857142857144,y:594.4285714285713},{x:187.71428571428572,y:594.4285714285713},{x:219,y:594.4285714285713},{x:250.28571428571428,y:594.4285714285713},{x:281.57142857142856,y:594.4285714285713},{x:312.85714285714283,y:594.4285714285713},{x:344.14285714285717,y:594.4285714285713},{x:375.4285714285714,y:594.4285714285713},{x:406.7142857142857,y:594.4285714285713},{x:438.00000000000006,y:594.4285714285713},{x:469.2857142857143,y:594.4285714285713},{x:500.5714285714286,y:594.4285714285713},{x:531.8571428571429,y:594.4285714285713},{x:187.71428571428572,y:625.7142857142858},{x:219,y:625.7142857142858},{x:250.28571428571428,y:625.7142857142858},{x:281.57142857142856,y:625.7142857142858},{x:312.85714285714283,y:625.7142857142858},{x:344.14285714285717,y:625.7142857142858},{x:375.4285714285714,y:625.7142857142858},{x:406.7142857142857,y:625.7142857142858},{x:438.00000000000006,y:625.7142857142858},{x:469.2857142857143,y:625.7142857142858},{x:500.5714285714286,y:625.7142857142858},{x:250.28571428571428,y:657},{x:281.57142857142856,y:657},{x:312.85714285714283,y:657},{x:344.14285714285717,y:657},{x:375.4285714285714,y:657},{x:406.7142857142857,y:657},{x:438.00000000000006,y:657},{x:469.2857142857143,y:657}];footer=null;container=null;content=null;logo=null;texts=null;$(window).load(function(){var e,t,n,r;footer=$(".infoBox");container=$(".infoBox .container");content=$(".infoBox .content");logo=$("#logo-footer");texts=$(".infoBox .texts");n=/Android|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);if(n){$(".cover").hide();$(".logoSvg").show();TweenMax.set($(".logoSvg img"),{top:0,opacity:0})}else{$(".logoSvg").hide();e=new Cover;$(window).resize(e.resize)}r=function(){var t=this;_gaq.push(["_trackEvent","Landing","showFooter","show_footer"]);TweenMax.to(footer,.5,{height:137,ease:"Quad.easeOut"});TweenMax.to(container,.5,{marginTop:20,marginBottom:20,height:71,ease:"Quad.easeOut"});return TweenMax.to(content,.5,{opacity:1,ease:"Quad.easeOut",onComplete:function(){return n?TweenMax.to($(".logoSvg img"),.5,{opacity:1}):e.init()}})};t=function(){TweenMax.to(content,.2,{opacity:0,ease:"Quad.easeOut"});TweenMax.to(footer,.3,{height:62,ease:"Quad.easeOut",delay:.1});return TweenMax.to(container,.3,{marginTop:0,marginBottom:0,height:62,ease:"Quad.easeOut",delay:.1})};return setTimeout(r,500)});window.console={log:function(){}};